...
local return_button = function()
         ...
         awful.spawn.easy_async_with_shell(
            ...
            function(stdout)
               ...
               if not stdout:match("Connected but no internet") then
                  ...
                  widget_icon_name = widget_icon_name
                     .. "-"
                     .. tostring(strength)
               ...
               widget.icon:set_image(
                  widget_icon_dir .. widget_icon_name .. ".svg"
               )
            end
         )
      end
      ...
      local update_wireless_strength = function()
         awful.spawn.easy_async_with_shell(
            ...
            function(stdout)
               ...
               local wifi_strength_rounded = math.floor(
                  wifi_strength / 25 + 0.5
               )
   ...
   local update_wired = function()
      ...
      local notify_connected = function()
         local message = 'Connected to internet with <b>"'
